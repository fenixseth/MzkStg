...
/**
 * Created by Android on 2014-06-15.
 */
...
public class DataHelper extends SQLiteOpenHelper
    ...
    private static String DATABASE_DIR = "/data/data/piofal.mzkstg/databases/"; //Ścieżka do katalogu gdzie przechowywane są bazy danych
    private static String DATABASE_NAME = "mzkbb.db"; //Nazwa pliku z bazą danych
    private static String DATABASE_ZIP = "mzkbb.zip"; //Nazwa pliku zip w którym znajduje się skompresowany plik z bazą danych
